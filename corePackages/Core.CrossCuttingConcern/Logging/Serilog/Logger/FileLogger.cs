using Core.CrossCuttingConcern.Logging.Serilog.ConfigurationModels;
using Core.CrossCuttingConcern.Logging.Serilog.Messages;
using Microsoft.Extensions.Configuration;
using Serilog;

namespace Core.CrossCuttingConcern.Logging.Serilog.Logger
{
